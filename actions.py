...
def ret():
    servo.move(Arm2.DOWN, 5)
    servo.move(Wrist.HORIZONTAL, 5)
    wait_for_button()
    gyro_turn(-40, -24, 10, False)
    stop_motors(200)
    servo.move(Arm2.LOWER, 2)
    gyro_turn(-40, -10, 8, False)
    stop_motors(200)
    servo.move(Wrist.DIAGONAL_VERTICAL, 2)
    servo.move(Arm2.LOW, 2)
    gyro_turn(-20, 40, 10, False)
    straight_drive_distance(50, 1.5, False)
    stop_motors(200)
    servo.move(Wrist.DIAGONAL_HORIZONTAL, 2)
    servo.move(Arm2.MIDDLE, 2)
    servo.move(Wrist.DIAGONAL_VERTICAL, 2)
    gyro_turn(40, 30, 8, False)
    straight_drive_distance(50, 3, False)
    gyro_turn(40, 0, 10, False)
    straight_drive_distance(50, 3, False)
    stop_motors(200)
    servo.move(Wrist.DIAGONAL_HORIZONTAL, 2)
    servo.move(Arm2.HIGH, 2)
    servo.move(Wrist.DIAGONAL_VERTICAL, 2)
    straight_drive_distance(50, 2, False)
    stop_motors(200)
